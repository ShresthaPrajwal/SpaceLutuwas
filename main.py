...
pygame.display.set_caption("Space Lutuwas")
icon = pygame.image.load('space-shuttle.png')
background = pygame.image.load('6484481.jpg')
pygame.display.set_icon(icon)

#background sound
mixer.music.load('music_tzichi_yanni_173bpm_dmin.wav')
mixer.music.play(-1)
...
# This function draws into the screen.So,this is op.
...
while running:
    ...
    if gameOverCheck==1:
        running = False
    pygame.display.update()  # Update tah garnai paryo ni sathi
# Game loop Ends here
gameSakyo = True
while gameSakyo:
    screen.fill((0, 0, 0))
    ...
    # overext =  font.render("Enter to play again",True,(0,255,0))
    # screen.blit(overext, (600,570)) 
    showScore()
